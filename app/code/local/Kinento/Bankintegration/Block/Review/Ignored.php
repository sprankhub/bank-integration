...
class Kinento_Bankintegration_Block_Review_Ignored extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct() {
		parent::__construct();

		$this->_blockGroup = 'bankintegration';
		$this->_controller = 'review_ignored';
		$this->_headerText = Mage::helper( 'bankintegration' )->__( 'Review bankdata (ignored items)' );
