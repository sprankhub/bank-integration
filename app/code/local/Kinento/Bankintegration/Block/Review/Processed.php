...
class Kinento_Bankintegration_Block_Review_Processed extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct() {
		parent::__construct();
		$this->_blockGroup = 'bankintegration';
		$this->_controller = 'review_processed';
		$this->_headerText = Mage::helper( 'bankintegration' )->__( 'Review bankdata (processed items)' );
